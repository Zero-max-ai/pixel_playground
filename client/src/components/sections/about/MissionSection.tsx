...
const MissionSection = () => {
  return (
    <div className="py-20 w-full flex flex-col items-center justify-center gap-10">
      ...
      <div className="w-full lg:w-10/12 flex max-md:flex-col items-center justify-between gap-20">
...
const MissionCard = ({ title, description }: missionProps) => {
  return (
    <div className="flex flex-col justify-center bg-white shadow rounded-[13px] p-4 max-w-[300px] h-[300px]">
