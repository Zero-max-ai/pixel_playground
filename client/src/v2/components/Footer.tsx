  ...
  return (
    <footer>
      <SectionLayout background={"bg-indigo-100"}>
        <div className="flex flex-col items-center justify-center gap-4 w-11/12 sm:w-7/12 mx-auto pt-5">
          ...
          <div className="flex items-center gap-7">
            {socialLinks.map(({ image, link }) => (
              <Link key={image} to={link} className="shadow-[4px_4px_0px_#e0e7ff] rounded-full">
                <img
                  src={image}
